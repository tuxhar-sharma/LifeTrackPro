...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#07090e] text-slate-900 dark:text-slate-100 selection:bg-indigo-500/30 selection:text-indigo-400 font-sans transition-colors duration-200">
      {/* Top Notification Announcement Bar */}
      <div className="bg-indigo-50 dark:bg-gradient-to-r dark:from-indigo-950/60 dark:via-indigo-900/40 dark:to-slate-950 border-b border-indigo-200/60 dark:border-indigo-500/20 py-2 px-4 text-center text-xs font-medium text-indigo-900 dark:text-indigo-300">
        <span className="inline-flex items-center gap-1.5 flex-wrap justify-center">
          <Sparkles className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400 animate-pulse" />
          <span>LifeTrack Pro v1.0 Public Release: Multi-Currency Ledger & Atomic Habit Engine Live</span>
          <Link to="/register" className="underline font-bold text-indigo-700 dark:text-white hover:text-indigo-900 dark:hover:text-indigo-200 ml-1">
            Claim Free Account →
          </Link>
        </span>
      </div>
      ...
      {/* Sticky Navigation */}
      <header className="sticky top-0 z-40 bg-white/80 dark:bg-slate-950/70 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800/80 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="font-bold text-lg text-slate-900 dark:text-white tracking-tight">
              LifeTrack <span className="text-indigo-600 dark:text-indigo-400">Pro</span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-white transition-all cursor-pointer shadow-xs"
            ...
            {isAuthenticated ? (
              ...
              <>
                <Link
                  to="/login"
                  className="px-3.5 py-2 text-xs font-medium text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white transition-colors"
                >
                  Sign In
                </Link>
                <Link
                  to="/register"
                  className="flex items-center gap-1 px-3.5 sm:px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-xs font-semibold text-white shadow-lg shadow-indigo-600/30 transition-all cursor-pointer"
                >
